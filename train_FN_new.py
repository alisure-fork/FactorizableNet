...
"""
CUDA_VISIBLE_DEVICES=0 python train_FN.py --evaluate --path_opt options/models/VRD.yaml --pretrained_model output/trained_models/Model-VRD.h5
"""
...
def main():
    ...
    train_set = getattr(datasets, options['data']['dataset'])(data_opts, 'train',
                                                              dataset_option=options['data'].get('dataset_option',
                                                                                                 None),
    ...
    # 2. resume training
        ...
        args.start_epoch, best_recall[0], exp_logger = load_checkpoint(model, optimizer,
                                                                       os.path.join(options['logs']['dir_logs'],
                                                                                    args.resume))
    else:
